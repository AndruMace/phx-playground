defmodule NewWeb.Router do
  use NewWeb, :router

  import NewWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {NewWeb.Layouts, :root}
  ...
  if Application.compile_env(:new, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: NewWeb.Telemetry
  ...
  scope "/", NewWeb do
    ...
    live_session :current_user,
      on_mount: [{NewWeb.UserAuth, :mount_current_scope}] do
